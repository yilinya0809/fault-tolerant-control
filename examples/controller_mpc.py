...
Q = ca.diagcat(1, 100, 100) # Gain matrix for X
R = ca.diagcat(0, 0, 10000) # Gain matrix for U
# W_z = ca.diagcat(50000, 0, 0)
# W_u = ca.diagcat(1, 10, 500000)
...
for k in range(N):
    ...
    # cost_fn = cost_fn + st_error.T @ W_z @ st_error + con.T @ W_u @ con
...
st_f = X[:, N]
con_f = U[:, N-1]
# cost_fn = cost_fn + st_f.T @ W_z @ st_f + con_f.T @ W_u @ con_f
