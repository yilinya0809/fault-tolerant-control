...
class Wind():
    ...
    def gust(self, t):
        vx = np.sum([
            self.jump_to(t, 5, 8, 2),
            self.jump_to(t, 10, 10.5, 4),
            self.jump_to(t, 14.5, 15, -4),
        ])
        vy = np.sum([
            self.jump_to(t, 10, 10.5, 4),
            self.jump_to(t, 14.5, 15, -4)
