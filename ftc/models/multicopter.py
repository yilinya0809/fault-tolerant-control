...
class Mixer:
    ...
    def __init__(self, d, c, b, rtype="hexa-x"):
...
class Multicopter(fym.BaseEnv):
    ...
    def __init__(
        ...
        super().__init__()
        self.pos = fym.BaseSystem(pos)
        self.vel = fym.BaseSystem(vel)
        self.quat = fym.BaseSystem(quat)
        self.omega = fym.BaseSystem(omega)
...
if __name__ == "__main__":
    ...
    omega = np.zeros((3, 1))
    system = Multicopter(pos, vel, quat, omega)
